...
import OperationLog from '../../frontend/src/views/system/operation-log/index.vue';
...
// Mock API calls
vi.mock('../../frontend/src/api/operation-log', () => ({
...
describe('OperationLog.vue', () => {
  ...
  beforeEach(() => {
    ...
    const {
      ...
      searchOperationLogs
    } = require('../../frontend/src/api/operation-log');
  ...
  describe('组件初始化', () => {
    ...
    it('应该在挂载时加载数据', async () => {
      const { getOperationLogs, getOperationLogStats } = require('../../frontend/src/api/operation-log');
  ...
  describe('数据加载', () => {
    ...
    it('应该能够刷新数据', async () => {
      const { getOperationLogs } = require('../../frontend/src/api/operation-log');
  ...
  describe('搜索和筛选', () => {
    it('应该能够按关键词搜索', async () => {
      const { searchOperationLogs } = require('../../frontend/src/api/operation-log');
    ...
    it('应该能够按用户ID筛选', async () => {
      wrapper.vm.searchForm.userId = '1';
    ...
    it('应该能够按IP地址筛选', async () => {
      wrapper.vm.searchForm.ipAddress = '192.168.1.100';
  ...
  describe('批量操作', () => {
    ...
    it('应该能够批量删除操作日志', async () => {
      const { batchDeleteOperationLogs } = require('../../frontend/src/api/operation-log');
  ...
  describe('数据导出', () => {
    it('应该能够导出当前页数据', async () => {
      const { exportOperationLogs } = require('../../frontend/src/api/operation-log');
  ...
  describe('实时更新', () => {
    ...
    it('应该能够设置刷新间隔', async () => {
      await wrapper.vm.setRefreshInterval(30000);
  ...
  describe('错误处理', () => {
    ...
    it('应该处理删除失败的情况', async () => {
      const { deleteOperationLog } = require('../../frontend/src/api/operation-log');
    ...
    it('应该处理统计数据加载失败的情况', async () => {
      const { getOperationLogStats } = require('../../frontend/src/api/operation-log');
