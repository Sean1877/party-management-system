...
import Statistics from '../../frontend/src/views/statistics/index.vue';
...
// Mock API calls
vi.mock('../../frontend/src/api/statistics', () => ({
...
describe('Statistics.vue', () => {
  ...
  beforeEach(() => {
    ...
    const {
      ...
      getFeeAnalysisStats
    } = require('../../frontend/src/api/statistics');
  ...
  describe('总体概览统计', () => {
    ...
    it('应该能够刷新总体数据', async () => {
      const { getOverviewStats } = require('../../frontend/src/api/statistics');
  ...
  describe('数据导出功能', () => {
    it('应该能够导出总体统计报告', async () => {
      const { exportStatisticsReport } = require('../../frontend/src/api/statistics');
  ...
  describe('错误处理', () => {
    ...
    it('应该处理加载组织数据失败的情况', async () => {
      const { getOrganizationStats } = require('../../frontend/src/api/statistics');
