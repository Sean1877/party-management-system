...
class ActivityServiceTest {
    ...
    void testFindUpcomingActivities() {
        // Given
        List<Activity> activities = Arrays.asList(testActivity);
        when(activityRepository.findUpcomingActivities(any(LocalDateTime.class), any(Pageable.class)))
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        verify(activityRepository).findUpcomingActivities(any(LocalDateTime.class), any(Pageable.class));
    }
    ...
    void testFindRecentActivities() {
        // Given
        List<Activity> activities = Arrays.asList(testActivity);
        when(activityRepository.findRecentActivities(any(LocalDateTime.class), any(Pageable.class)))
            .thenReturn(activities);
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        verify(activityRepository).findRecentActivities(any(LocalDateTime.class), any(Pageable.class));
    }
    ...
    void testExistsByTitle() {
        // Given
        when(activityRepository.existsByTitle("党史")).thenReturn(true);
