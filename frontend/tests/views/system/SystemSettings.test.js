...
describe('SystemSettings.vue', () => {
  ...
  describe('组件初始化', () => {
    ...
    it('应该在挂载时加载配置数据', async () => {
      const { getSystemConfigs } = require('@/api/system-config')
  ...
  describe('配置项编辑', () => {
    ...
    it('应该能够保存配置修改', async () => {
      const { updateSystemConfig } = require('@/api/system-config')
    ...
    it('应该能够创建新配置', async () => {
      const { createSystemConfig } = require('@/api/system-config')
    ...
    it('应该能够删除配置项', async () => {
      const { deleteSystemConfig } = require('@/api/system-config')
  ...
  describe('批量操作', () => {
    it('应该能够批量更新配置', async () => {
      const { batchUpdateSystemConfigs } = require('@/api/system-config')
    ...
    it('应该能够重置配置到默认值', async () => {
      const { resetSystemConfigs } = require('@/api/system-config')
  ...
  describe('配置导入导出', () => {
    it('应该能够导出配置', async () => {
      const { exportSystemConfigs } = require('@/api/system-config')
    ...
    it('应该能够导入配置', async () => {
      const { importSystemConfigs } = require('@/api/system-config')
