...
import FeeManagement from '@/views/fee/index.vue'
...
describe('FeeManagement.vue', () => {
  ...
  beforeEach(() => {
    ...
    // Mock API responses
    const { getFeeStandards, getFeePayments } = require('@/api/fee')
  ...
  describe('党费标准管理', () => {
    ...
    it('应该能够提交新增标准表单', async () => {
      const { createFeeStandard } = require('@/api/fee')
    ...
    it('应该能够提交编辑标准表单', async () => {
      const { updateFeeStandard } = require('@/api/fee')
    ...
    it('应该能够删除党费标准', async () => {
      const { deleteFeeStandard } = require('@/api/fee')
  ...
  describe('党费缴费记录管理', () => {
    ...
    it('应该能够提交新增缴费记录表单', async () => {
      const { createFeePayment } = require('@/api/fee')
    ...
    it('应该能够删除缴费记录', async () => {
      const { deleteFeePayment } = require('@/api/fee')
  ...
  describe('数据导出功能', () => {
    it('应该能够导出党费标准数据', async () => {
      const { exportFeeData } = require('@/api/fee')
  ...
  describe('错误处理', () => {
    it('应该处理加载数据失败的情况', async () => {
      const { getFeeStandards } = require('@/api/fee')
