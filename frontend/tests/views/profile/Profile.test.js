...
describe('Profile.vue', () => {
  ...
  describe('用户资料管理', () => {
    ...
    it('应该能够保存用户资料', async () => {
      const { updateUserProfile } = require('@/api/user')
  ...
  describe('安全设置', () => {
    it('应该能够启用双因子认证', async () => {
      const { enableTwoFactor } = require('@/api/user')
    ...
    it('应该能够禁用双因子认证', async () => {
      const { disableTwoFactor } = require('@/api/user')
    ...
    it('应该能够绑定第三方账号', async () => {
      const { bindThirdPartyAccount } = require('@/api/user')
    ...
    it('应该能够解绑第三方账号', async () => {
      const { unbindThirdPartyAccount } = require('@/api/user')
  ...
  describe('数据导出', () => {
    it('应该能够导出个人数据', async () => {
      const { exportUserData } = require('@/api/user')
