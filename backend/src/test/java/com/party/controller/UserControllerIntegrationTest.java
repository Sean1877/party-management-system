...
class UserControllerIntegrationTest {
    ...
    void testUpdateUser() throws Exception {
        ...
        updateRequest.put("id", savedUser.getId());
    ...
    void testCreateUserWithDuplicateUsername() throws Exception {
        ...
        Map<String, Object> duplicateUserRequest = new HashMap<>();
        duplicateUserRequest.put("username", testUser.getUsername()); // 重复的用户名
        duplicateUserRequest.put("password", "password123");
        duplicateUserRequest.put("realName", "重复用户");
        duplicateUserRequest.put("idCard", "987654321098765432");
        duplicateUserRequest.put("phone", "13900139000");
        duplicateUserRequest.put("email", "duplicate@example.com");
        duplicateUserRequest.put("gender", 1);
        duplicateUserRequest.put("organizationId", 1);
        duplicateUserRequest.put("roleId", 2);
